...
export async function updateTerritoryWorkflows(
    ...
    //     slog.info(`Processing flow ${index+1}/${flowIds.length}`,
    //         TAB+`flowId: ${flowId}`,
    ...
    //     slog.info(`Finished updating territory branches.`,
    ...
    //     slog.info(`Finished updating region branches.`,
...
export async function updateTerritoryBranches(
    ...
    // const zipDict = territoryZipDict || territoryData.compositeTerritoryDict;
    // const propList = targetProps || territoryData.territoryZipProperties;
    // let result: Flow;
...
export async function updateRegionBranches(
    ...
    // // Get data from the loader
    // const territoryData = getTerritoryData() as TerritoryData;
    // const zipDict = regionZipDict || territoryData.regionDict;
    // const propList = targetProps || territoryData.regionZipProperties;
